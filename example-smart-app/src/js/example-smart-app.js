...
(function(window){
  ...
  window.drawVisualization = function(p) {
	...
	if ( admissionJSON.list.length > 7)
	{
	...
	if ( rxJSON.list.length > 7)
	{
		$('#rxDiv').css({height:"250px",overflow:"auto"});
		
	}
	
	$('#patientTable').dynatable({
		  dataset: {
				
				records: careGapJSON.list
				},
